...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { Estado_id: @cidade.Estado_id, nome: @cidade.nome } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { Estado_id: @cidade.Estado_id, nome: @cidade.nome } }
