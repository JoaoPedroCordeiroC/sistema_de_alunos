...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { mae: @aluno.mae, pai: @aluno.pai, pessoa_id: @aluno.pessoa_id } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { mae: @aluno.mae, pai: @aluno.pai, pessoa_id: @aluno.pessoa_id } }
